namespace NeosIT.Exchange.GenericExchangeTransportAgent.Plugins.UncompressAttachmentHandler.Impl.Forms
{
    using System;
    ...
    {
        private readonly UncompressAttachmentHandler _handler;

        public ConfigForm(UncompressAttachmentHandler handler)
        {
            _handler = handler;
            InitializeComponent();
        }
